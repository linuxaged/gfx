...
#    elif defined( OS_ANDROID )
    ...
    if ( timeBase == 0 )
    {
        timeBase = (ksNanoseconds)ts.tv_sec * 1000ULL * 1000ULL * 1000ULL +
                   static_cast<unsigned long long>( ts.tv_nsec );
    }

    //	return (ksNanoseconds) ts.tv_sec * 1000ULL * 1000ULL * 1000ULL + ts.tv_nsec-timeBase;
    return (ksNanoseconds)ts.tv_sec * 1000ULL * 1000ULL * 1000ULL +
           static_cast<unsigned long long>( ts.tv_nsec );
#    elif defined( OS_HEXAGON )
...
static double vrapi_GetTimeInSeconds() { return double( GetTimeNanoseconds() ) * 0.000000001; }
static double GetTimeInSeconds() { return double( GetTimeNanoseconds() ) * 0.000000001; }
static float GetTimeInMillisecond() { return float( GetTimeNanoseconds() ) * 0.000001f;}
